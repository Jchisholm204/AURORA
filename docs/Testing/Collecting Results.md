...
This data may be futher processed into heatmaps using the plotting script, described in [Generating Plots#Block Test Heatmaps](Generating%20Plots%23Block%20Test%20Heatmaps), or the statistics script, described in [Generating Statistics#Block Test Heatmap Statistics](Generating%20Statistics%23Block%20Test%20Heatmap%20Statistics).
...
The data produced by this script may be plotted using the scripts described in [Generating Plots#Heat Distribution Benchmark](Generating%20Plots%23Heat%20Distribution%20Benchmark).
...
The data produced by this script may be plotted using the scripts described in [Generating Plots#Checkpoint Benchmarks](Generating%20Plots%23Checkpoint%20Benchmarks)
Futher statistics can also be calculated using the scripts described in [Generating Statistics#Heat Distribution Statistics](Generating%20Statistics%23Heat%20Distribution%20Statistics).
...
The data produced by this script may be plotted using the scripts described in [Generating Plots#Restart Time](Generating%20Plots%23Restart%20Time).
