...
The `block_test.py` script can be used to generate statistics from [Collecting Results#Block Tests](Collecting%20Results%23Block%20Tests).
...
The `heatdis_compare.py` script can be used to generate statistics from [Collecting Results#Summary Times](Collecting%20Results%23Summary%20Times).
