...
## Initialization
- AURORA is initialized using the [AURORA Client Configuration](AURORA%20Client%20Configuration.md) structure
...
- Returns:
	- `0` if OK
	- Positive value for [AURORA Completion Notification - ACN](../Common%20Lib/AURORA%20Completion%20Notification%20-%20ACN.md) errors
	- Negative value for [AURORA Region Manager - ARM](../Common%20Lib/AURORA%20Region%20Manager%20-%20ARM.md) errors
