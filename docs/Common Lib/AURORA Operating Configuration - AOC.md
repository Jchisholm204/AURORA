...
- Options here are linked to a subset of the options in the [AURORA Client Configuration](../Client%20Lib/AURORA%20Client%20Configuration.md)
...
- Returns:
	...
	- (only free returned memory using [#Deconstruction](#Deconstruction))
