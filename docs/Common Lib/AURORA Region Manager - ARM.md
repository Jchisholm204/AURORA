...
## Initialization
- Requires:
	- [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI) (Connected)
### Instance Creation
...
- Must be called before [AURORA Connection Instance - ACI#Deconstruction](AURORA%20Connection%20Instance%20-%20ACI%23Deconstruction)
...
### Remove Region
- Opposite function to [#Add Region](%23Add%20Region)
...
- Unfolds to [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI) RDMA Write -> RDMA Write
```c
/**
...
- Unfolds to [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI) RDMA Read -> RDMA Read
```c
/**
