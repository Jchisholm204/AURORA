...
- The sync mechanism is performed using [ticks](#Standard%20Interface).
- Requires:
	- [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI.md)
	- [AURORA Blob](AURORA%20Blob.md)
	- UCP

## Initialization
- Uses the same initialization structure as the [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI.md)
- Requires:
	- [AURORA Connection Instance - ACI](AURORA%20Connection%20Instance%20-%20ACI.md) (Instance, not connected)
	- Empty [AURORA Blob](AURORA%20Blob.md) from the [ADS](ADS)
### Instance Creation
...
- This function also frees data from [#Instance Creation](#Instance%20Creation)
- Requires:
	- An existing ACN ([#Instance Creation](#Instance%20Creation))
