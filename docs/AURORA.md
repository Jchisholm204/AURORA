...
Instructions on dependencies and building can be found in [Building](Building).
Server usage can be found under the [Server Docs](Server%20Docs), while user API documentation is under [Client Lib](Client%20Lib)
Internal documentation, and documentation for the [Common Lib](Common%20Lib) is also under [Common Lib](Common%20Lib).
Finally, [Research/CheckpointRestart/AURORA/Testing/Testing|Docs/Testing](Research%2FCheckpointRestart%2FAURORA%2FTesting%2FTesting%7CDocs%2FTesting) contains documentation on how to run the testing scripts and reproduce paper results.
### Building, Installation & Releases
Steps and instructions for building the code can be found under [Building](Building).
Installation is handled via CMake packaging, see [Installing](Installing) for further details.
...
For further details on the AURORA User Library, and usage, see the [Client Lib](Client%20Lib) Docs.
