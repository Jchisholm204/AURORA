...
if(NOT ucx_FOUND)
    ...
    if(UCX_INCLUDE_DIR AND UCX_UCP_LIB)
        ...
        target_include_directories(${CMAKE_PROJECT_NAME}::ucx
            INTERFACE ${UCX_INCLUDE_DIR})
        target_link_libraries(${CMAKE_PROJECT_NAME}::ucx 
            INTERFACE ${UCX_UCP_LIB} ${UCX_UCT_LIB} ${UCX_UCS_LIB})
        set(UCX_FOUND TRUE)
    else()
